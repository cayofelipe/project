...
public interface Game {
     ...
     * @return O enum game.rules.Color que representa a cor da posição
     */
     ...
     * @param position Posição do tabuleiro
     * @return Um objeto game.board.Piece que representa a peça na posição indicada. Se não tiver peça, devolve null
     */
    Piece getPiece(Position position);

    /**
     * Método que devolve a carta que está na mesa, que será substituída após a próxima jogada
     * @return Um objeto game.pieces.Card que representa a carta na mesa
     */
    Card getTableCard();
